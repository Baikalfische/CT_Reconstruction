...
# plt.gray()
# plt.title('filtered rebinned sinogram from short-scan fanogram')
# plt.show()
...
plt.gray()
plt.title('short-scan reco from sinogram')
plt.show()
